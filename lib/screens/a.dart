...
class _MyBookingsState extends State<MyBookings> {
  ...
  Future<void> _submitReview(
    ...
    try {
      ...
      // إرسال الحقول المطلوبة: stars كـ float و review كـ string

      final Map<String, dynamic> bodyData = {
        "stars": rating, // float
      };

      // إرسال حقل review فقط إذا كان يحتوي على نص

      if (comment.trim().isNotEmpty) {
        bodyData["review"] = comment.trim();
      }
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        debugPrint("Error 422 details: ${response.body}");
